...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-2xl bg-muted/50 backdrop-blur-sm p-1 text-muted-foreground border border-muted/30 shadow-sm",
      className
    )}
    {...props}
  />
